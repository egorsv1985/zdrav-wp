...
<div class="hero">
  <!-- <picture>
          <source class="hero__ring" srcset="<?php echo get_template_directory_uri(); ?>/assets/img/ring-hero.webp"type="image/webp" alt="">
          <img class="hero__ring" src="<?php echo get_template_directory_uri(); ?>/assets/img/ring-hero.png" alt="" />
      </picture> -->
  <img src="<?php echo get_template_directory_uri(); ?>/assets/img/ring-hero.svg" alt="" class="hero__ring">
...
<div class="first-screen-overlay">
  ...
  <div class="container">
    ...
    <div class="author" id="author">
      ...
      <picture>
        <source class="author__ring" srcset="<?php echo get_template_directory_uri(); ?>/assets/img/ring-author.webp" type="image/webp" alt="">
        <img class="author__ring" src="<?php echo get_template_directory_uri(); ?>/assets/img/ring-author.png" alt="" />
      </picture>
    </div>
