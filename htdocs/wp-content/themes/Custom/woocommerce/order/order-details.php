			...
			foreach ( $order->get_order_item_totals() as $key => $total ) {
				?>
					<div  class="d-flex jcsb">
						<div class="one" scope="row"><?php echo esc_html( $total['label'] ); ?></div>
						<div class="one"><?php echo ( 'payment_method' === $key ) ? esc_html( $total['value'] ) : wp_kses_post( $total['value'] ); // phpcs:ignore WordPress.Security.EscapeOutput.OutputNotEscaped ?></div>
					</div>
					<?php
			}
			?>
